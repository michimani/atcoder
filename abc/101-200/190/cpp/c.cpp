...
void gen(vector<vector<unsigned int>>& choices,
         vector<vector<unsigned int>>& balls_list, vector<unsigned int> balls,
         map<unsigned int, bool> selected, unsigned int pos) {
    if (pos == choices.size()) {
