...
bool comp_year(const tuple<unsigned int, unsigned int, unsigned int>& l,
               const tuple<unsigned int, unsigned int, unsigned int>& r) {
...
int main() {
    ...
    vector<tuple<unsigned int, unsigned int, unsigned int>> y_i_list(
        m);  // Y, i, P
